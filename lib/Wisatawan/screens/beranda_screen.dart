...
class BerandaScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final List<Map<String, dynamic>> destinasiFavorit = semuaDestinasi.sublist(
      0,
      4,
    );
    final List<Map<String, dynamic>> destinasiRekomendasi = semuaDestinasi
        .sublist(4, 8);
  ...
  Widget _bangunKolomPencarianDanProfil(BuildContext context) {
    return Row(
      children: <Widget>[
        Image.asset('assets/images/Wanderlust Logo Circle.png', height: 45),
  ...
  Widget _bangunDaftarDestinasiHorizontal(
